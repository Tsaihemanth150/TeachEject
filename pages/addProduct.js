    ...
    <div className="max-w-2xl mx-auto mt-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="flex flex-col">
          ...
          <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} required className="border border-gray-300 rounded-md px-4 py-2 mt-1 focus:outline-none focus:border-blue-500" />
        </div>
        <div className="flex flex-col">
          <label htmlFor="type" className="text-lg">Type:</label>
          <input type="text" id="type" name="type" value={formData.type} onChange={handleChange} required className="border border-gray-300 rounded-md px-4 py-2 mt-1 focus:outline-none focus:border-blue-500" />
        </div>
        <div className="flex flex-col">
          <label htmlFor="tier" className="text-lg">Tier:</label>
          <input type="text" id="tier" name="tier" value={formData.tier} onChange={handleChange} required className="border border-gray-300 rounded-md px-4 py-2 mt-1 focus:outline-none focus:border-blue-500" />
        </div>
        <div className="flex flex-col">
          <label htmlFor="tenure" className="text-lg">Tenure:</label>
          <input type="number" id="tenure" name="tenure" value={formData.tenure} onChange={handleChange} required className="border border-gray-300 rounded-md px-4 py-2 mt-1 focus:outline-none focus:border-blue-500" />
        </div>
        <div className="flex flex-col">
          <label htmlFor="basePremium" className="text-lg">Base Premium:</label>
          <input type="number" id="basePremium" name="basePremium" value={formData.basePremium} onChange={handleChange} required className="border border-gray-300 rounded-md px-4 py-2 mt-1 focus:outline-none focus:border-blue-500" />
        </div>
        {/* Coverage Options */}
        ...
        <div className="space-y-2">
          ...
          {formData.additionalFeatures.map((feature, index) => (
            <div key={index} className="flex flex-col space-y-2">
              ...
              <input type="text" id={`additionalFeature${index}`} name={`additionalFeature${index}`} value={feature} onChange={(e) => handleAdditionalFeatureChange(index, e)} required className="border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:border-blue-500" />
            </div>
          ))}
